...
output "ddb_tvshow_ric_table_name" {
  value = aws_dynamodb_table.tvshow_release_indexer_context.name
}

output "ddb_tvshow_ric_table_stream_arn" {
  value = aws_dynamodb_table.tvshow_release_indexer_context.stream_arn
}
