import { ClassStaticProperties } from "../types/ClassStaticProperties";
...
export class AudioLang {
  ...
  static fromKeyOrThrow(key: keyof ClassStaticProperties<typeof AudioLang>): AudioLang {
  ...
  static fromKey(key: Nullable<keyof ClassStaticProperties<typeof AudioLang>>): Nullable<AudioLang> {
    if (key == null) return null;
    return AudioLang[key];
  }

  public static fromISO_639_2(code: Nullable<keyof typeof this.FROM_ISO_639_2>) {
    if (code == null) return null;
    return this.FROM_ISO_639_2[code];
  }

  public static fromISO_639_1(code: Nullable<keyof typeof this.FROM_ISO_639_1>) {
    if (code == null) return null;
