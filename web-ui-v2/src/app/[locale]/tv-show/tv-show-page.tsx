    ...
    >
      ...
      <AppShell.Main>
        ...
        <Container size="xl">
          ...
          <Space h="xl"/>
          <Player movieTitle={playerTitle} m3u8File={props.player.m3u8File} backdropImage={props.player.backdropImage} thumbnailsFile={props.player.thumbnailsFile} subtitles={{}}/>
        </Container>
      </AppShell.Main>
    </AppShell>
  );
