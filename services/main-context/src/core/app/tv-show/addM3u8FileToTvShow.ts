...
export const handler = async (event: AddM3u8FileParam): Promise<void> => { 
  const queryParams = {
  ...
  tvShow.addM3u8File(event.season, event.episode, event.relativePath);
