...
async function updateBasedOnTmdbId(movieId: string, tmdbId: string, tmdbApiKey: string, movieRead: MovieRead) {
  ...
  tmdbCredits.cast.forEach(_ => {
    ...
    if (p != undefined && _.known_for_department === "Acting" && movie.addActor(p)) {
      updated = true;
    }
  });
...
const tmdbPersonId2Person = {
  ...
  "73457" : new Person("CHRIS_PRATT"),
  "90633" : new Person("GAL_GADOT"),
  "204" : new Person("KATE_WINSLET"),
  "78110" : new Person("SCOTT_ADKINS"),
  "72129" : new Person("JENNIFER_LAWRENCE"),
  "19034" : new Person("EVANGELINE_LILLY"),
  "1160" : new Person("MICHELLE_PFEIFFER"),
  "3392" : new Person("MICHAEL_DOUGLAS"),
  "234352" : new Person("MARGOT_ROBBIE"),
  "30614" : new Person("RYAN_GOSLING"),
  "23659" : new Person("WILL_FERRELL"),
  "3" : new Person("HARRISON_FORD"),
  "3131" : new Person("ANTONIO_BANDERAS"),
  ...
  "5292" : new Person("DENZEL_WASHINGTON"),
  ...
  "1003" : new Person("JEAN_RENO"),
  "524" : new Person("NATALIE_PORTMAN"),
  "59" : new Person("LUC_BESSON"),
  "2636" : new Person("ALFRED_HITCHCOCK"),
  "550843" : new Person("ELIZABETH_OLSEN"),
  "71580" : new Person("BENEDICT_CUMBERBATCH"),
  "15217" : new Person("ZACK_SNYDER"),
  "776" : new Person("EDDIE_MURPHY"),
  ...
  "738" : new Person("SEAN_CONNERY"),
  "17288" : new Person("MICHAEL_FASSBENDER"),
  "55638" : new Person("KEVIN_HART"),
  ...
  "2963" : new Person("NICOLAS_CAGE"),
  "58021" : new Person("TINTO_BRASS")
 } as const;
